...
gen-server: # Generate server protobuf files
	protoc --proto_path protobuf/ \
		...
		--plugin=protoc-gen-grpc-gateway=/root/go/bin/protoc-gen-grpc-gateway \
		--grpc-gateway_out pkg/api/v1 \
		--grpc-gateway_opt logtostderr=true \
		--grpc-gateway_opt paths=source_relative \
		--grpc-gateway_opt allow_delete_body=true \
		protobuf/inventory-service.proto
	protoc --proto_path protobuf/ \
		--proto_path protobuf/google/ \
		--experimental_allow_proto3_optional \
		--plugin=protoc-gen-openapiv2=/root/go/bin/protoc-gen-openapiv2 \
		--openapiv2_out docs \
